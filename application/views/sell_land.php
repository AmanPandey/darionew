  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      ...
      <form action="#" method="post">
       ...
       <div class="form-group">
         <label for="locations" class="input-title">Land Location</label>
         <input type="text" class="form-control" id="locations" aria-describedby="emailHelp" required placeholder="Enter your land location">
       </div>
       
       <div class="form-group">
         <label for="rquirment" class="input-title">Land Details </label>

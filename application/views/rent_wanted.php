...
<div class="container">
  <div class="row">
    ...
    <br/>
    <h2>LOOKING FOR RENTAL PROPERTIES?</h2>
    </div>
  </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      ...
      <form action="#" method="post">
       ...
       <div class="form-group">
         <label for="locations" class="input-title">Property Locations</label>
         <input type="text" class="form-control" id="locations" aria-describedby="emailHelp" required placeholder="Enter your property locations">
       </div>

...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      <h2><strong>Atal Mission for Rejuvenation and Urban Transformation</strong> </h2>
      <h6>Posted, Jan 09, 2022</h6>
      <div class="fakeimg">
      <img src="assets/img/blog2.png" width="100%"/>
     </div>
...
Hybrid deployment by combining the High Availability Solution with Disaster Recovery Solution for SQL Server at a database level with AlwaysOn Availability Groups has been used as HADR Solution for Swachh Bharat Mission-Gramin.
  ...
  <div class="rightcolumn">
    <div class="card">
      <h3>Popular Post</h3>
      <div class="fakeimg"><a href="<?php echo base_url('Swachh-Bharat-Mission') ?>" class="text-white">Swachh Bharat Mission</a></div><br>
      <div class="fakeimg"><a href="<?php echo base_url('Smart-Cities') ?>" class="text-white">Smart Cities</a></div><br>
      <div class="fakeimg"><a href="<?php echo base_url('Atal-Mission-for-Rejuvenation-and-Urban-Transformation') ?>" class="text-white">Atal Mission for Rejuvenation and Urban Transformation</a></div><br>
      <div class="fakeimg"><a href="<?php echo base_url('Scheme-for-Satellite-Towns-around-seven-megacities') ?>" class="text-white">Scheme for Satellite Towns around seven megacities</a></div><br>
      <div class="fakeimg"><a href="<?php echo base_url('Pradhan-Mantri-Awas-Yojana') ?>" class="text-white">Pradhan Mantri Awas Yojana</a></div><br>
      <div class="fakeimg"><a href="<?php echo base_url('Deendayal-Antyodaya-Yojana-National-Urban-Livelihoods-Mission') ?>" class="text-white">Deendayal Antyodaya Yojana National Urban Livelihoods Mission</a></div><br>
      <div class="fakeimg"><a href="<?php echo base_url('Rajiv-Awas-Yojana') ?>" class="text-white">Rajiv Awas Yojana</a></div><br>
    </div>
  </div>
</div>

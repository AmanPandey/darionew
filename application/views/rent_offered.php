    ...
    <div class="col-sm-6">
      ...
      <form action="#" method="post">
       ...
       <div class="form-group">
         ...
         <input type="text" class="form-control" id="locations" aria-describedby="emailHelp" required placeholder="Enter your property location">
       </div>
       
       <div class="form-group">
         <label for="rquirment" class="input-title">Property Details</label>
         <textarea class="form-control" id="rquirment" rows="3" required placeholder="please explain your basic details of the property"></textarea>
       </div>

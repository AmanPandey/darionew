...
<div class="container">
  <div class="row">
    ...
    <br/>
    <h2>BUY RESIDENTIAL PROPERTY</h2>
    </div>
  </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      ...
      <form action="#" method="post">
       ...
       <div class="form-group">
         <label for="locations" class="input-title">New Property Locations</label>
         <input type="text" class="form-control" id="locations" aria-describedby="emailHelp" required placeholder="Enter your new property prefrence locations">
       </div>
       
       <div class="form-group">
         <label for="rquirment" class="input-title">Basic Requiment Details </label>
       ...
       <div class="form-group">
         <label for="budget" class="input-title">Estimated Budget</label>
